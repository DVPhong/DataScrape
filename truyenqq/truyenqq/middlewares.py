...
class TruyenqqSpiderMiddleware:
...
class TruyenqqDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self,settings) -> None:
        ...
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_USER_AGENT_ENDPOINT', 'http://headers.scrapeops.io/v1/user-agents?')
    ...
    def _get_user_agents_list(self):
        ...
        self.user_agents_list = response_json.get('result', [])
